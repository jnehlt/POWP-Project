...
public class ProfilesRepository {
    public Stream<Profile> getAllProfiles(){
        var profile1 = new Profile(1,"Jan", "Kowalski", "Szef wszystkich szefów", "jk@powp.com", "123456789");
        var profile2 = new Profile(2,"Igrek", "Iksiński", "Konserwator powieszchni płaskich", "ii@powp.com", "987321456");
        var profile3 = new Profile(3, "John", "Doe", "Manager", "jd@powp.com", "999888777");
